...
def plot_cl_alm(alm, settings, **kwargs):
    cl = curvedsky.alm2cl(alm)
    plot_cl(cl, settings, **kwargs)


def plot_cl_map(map, wcs, settings, **kwargs):
...
def plot_cl_patch(patch, settings, **kwargs):
    cl = hp.anafast(patch, settings.lmax)
