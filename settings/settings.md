...
- `lmax_buffer`, 512 : Buffer for the lmax parameter used in some camb calculations to ensure that the code can calculate the required power spectra and lensing to sufficient lmax.
