...
class GRN(Layer):
    """See section 4, Algorithm 1, of Woo 2023, 2301.00808"""
    ...
    def call(self, inputs):
        # TODO: Could this norm be changed to something spherical?
        gx = tf.norm(inputs, ord=2, axis=(1), keepdims=True)  # type: ignore
...
def main():
    ...
    model.save(f"{core.name}.h5", save_format="tf")
