...
from keras.callbacks import (EarlyStopping, ModelCheckpoint, ReduceLROnPlateau,
                             TensorBoard)
from keras.layers import (Activation, Concatenate, Conv1D, Dense, Dropout,
                          Flatten, Lambda)
from keras.optimizers.legacy import Adam
from keras.optimizers.schedules import ExponentialDecay
from keras.regularizers import l2

from nnhealpix.layers import ConvNeighbours, Dgrade, MaxPooling
...
def alm_model(
    ...
    out_layer = Conv1D(1, 9, padding='same')(out_layer)
    out_layer = Flatten()(out_layer)
    out_layer = Dense(512)(out_layer)
    out_layer = Dense(256)(out_layer)
...
if __name__ == "__main__":
    ...
    with strategy.scope():
        input = Input((Alm.getsize(s.lmax), 1), name="input")
