...
do
    ...
    #
    # if you want to you surround the interior of the for loop with `( )&` to 
    # run all the jobs in parallel, but be carefuly about the settings collisions

    # JOB0_ID=$(sbatch $JOB0 "$SETTINGSFILE" | awk '{print $4}')
